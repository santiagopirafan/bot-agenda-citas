...
if __name__ == "__main__":
    # Las siguientes líneas solo se ejecutan al correr 'python main.py' directamente en la terminal
    tel_prueba1 = "3001234567"
    tel_prueba2 = "3119876543"
    
    print("--- PRUEBAS DE LIMPIEZA DE BASE DE DATOS ---")
    print(recibir_mensaje(tel_prueba1, "eliminar"))
    print(recibir_mensaje(tel_prueba2, "eliminar"))