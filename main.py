...
# ==========================================
# SERVIDOR WEB FLASK PARA RAILWAY & WHATSAPP
# ==========================================
...
# 2. Ruta de Webhook conectada a la función recibir_mensaje
...
def webhook():
    ...
    # Llama a tu función recibir_mensaje del mismo archivo
    respuesta_bot = recibir_mensaje(telefono, texto)

    return jsonify({"respuesta": respuesta_bot})

# 3. Arranque del Servidor en el Puerto de Railway
